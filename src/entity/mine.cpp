...
Mine::Mine()
    : width_(0), height_(0), x_pos_(0), y_pos_(0), alive_(false),
...
int Mine::get_image_width() const { return width_; }

int Mine::get_image_height() const { return height_; }

bool Mine::is_alive() const { return alive_; }
